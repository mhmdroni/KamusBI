...
public class KamusIndoBetawiAdapter extends RecyclerView.Adapter<KamusIndoBetawiAdapter.MyViewHolder> {
    List<Kamus> kamusList;
    Context context;

    public KamusIndoBetawiAdapter(List<Kamus> kamusList, Context context) {
    ...
    @NonNull
    @Override
    public KamusIndoBetawiAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.kamus_item, parent, false);
        return new MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull KamusIndoBetawiAdapter.MyViewHolder holder, int position) {
